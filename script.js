...
(function initCellField() {
  ...
  const cells = [
    { s: 480, x:  5, y: 10, d: 24, del:   0, c: '144,202,249' },
    { s: 300, x: 72, y: 55, d: 18, del:  -6, c: '179,229,252' },
    { s: 370, x: 42, y: 78, d: 28, del: -12, c: '186,230,253' },
    { s: 195, x: 88, y:  8, d: 16, del:  -3, c: '144,202,249' },
    { s: 540, x: 26, y: 42, d: 32, del:  -9, c: '224,242,254' },
    { s: 240, x: 62, y: 22, d: 20, del: -15, c: '186,230,253' },
    { s: 155, x: 14, y: 87, d: 14, del:  -2, c: '144,202,249' },
  ];
